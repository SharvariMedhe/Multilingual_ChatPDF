...
from utils.language_utils import lang_detect, translate_transformer
...
class ChatBot:
    ...
    """
    @staticmethod
    def respond(chatbot: List, message: str, data_type: str = "Preprocessed doc") -> Tuple:
        """
        ...
        """
        temperature = 0.0
        # print(target_lang, type(target_lang))
        # src_lang = 'english'
        # if target_lang.lower() == "hindi":
        #     src_lang = "hi"
        # elif target_lang.lower() == "german":
        #     src_lang = "de"
        # elif target_lang.lower() == "french":
        #     src_lang = "fr"
        # elif target_lang.lower() == "marathi":
        #     src_lang = "mr"  
       
        detect_lang = lang_detect(message)
        
        if detect_lang != 'en': 
            message = translate_transformer(message, detected_lang=detect_lang, tgt_lang="en")
            print(type(message))
        ...
        if detect_lang != 'en': 
            chatgpt_response =  translate_transformer(response.choices[0].message.content, detected_lang="en",tgt_lang=detect_lang)
        else:
